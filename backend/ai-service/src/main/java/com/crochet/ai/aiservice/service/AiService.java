...
public class AiService {
    ...
    public PatternDecoderResponse decodePattern(String userId, PatternDecoderRequest request) {
        ...
        ChatSessionEntity session = ChatSessionEntity.builder()
                ...
                .category(ChatCategory.PATTERN_DECODER)
                .messages(new ArrayList<>())
                .build();
    ...
    private String callGeminiForPatternDecoder(String base64Image, String mimeType) {
        ...
        try {
            ...
            log.error("Error communicating with Google's Gemini API during pattern decoding: {}", e.getMessage(), e);
            return "Apologies! Our AI service is currently experiencing high traffic or is temporarily unavailable. Please try again later.";
        }
    ...
    public PatternDecoderResponse reverseEngineer(String userId, PatternDecoderRequest request) {
        ...
        ChatSessionEntity session = ChatSessionEntity.builder()
                ...
                .category(ChatCategory.REVERSE_ENGINEER)
                .messages(new ArrayList<>())
                .build();
    ...
    private String callGeminiForReverseEngineer(String base64Image, String mimeType) {
        ...
        try {
            ...
            log.error("Error communicating with Google's Gemini API during reverse engineering: {}", e.getMessage(), e);
            return "Apologies! Our AI service is currently experiencing high traffic or is temporarily unavailable. Please try again later.";
        }
