...
export function CrochetLoader({ onComplete }: CrochetLoaderProps) {
 ...
 className="fixed inset-0 bg-surface flex flex-col justify-center items-center z-50 p-4 font-sans select-none overflow-hidden"
 >
 ...
 className="w-full max-w-lg fabric-card p-8 md:p-12 relative flex flex-col items-center shadow-2xl"
 >
 {/* Cute decorative crochet flower label in top corner */}
 <div className="absolute -top-4 -right-4 bg-brand-light text-heading text-xl p-3 rounded-full warm-shadow border-2 border-white">
 🌸
 </div>
 <div className="absolute -bottom-4 -left-4 bg-accent text-white text-xl p-3 rounded-full warm-shadow border-2 border-white">
 🧶
 </div>

 {/* Crocheting illustration header */}
 <h2 className="text-heading font-serif text-2xl md:text-3xl font-bold tracking-tight text-center mb-1">
 Craft Greenhouse
 </h2>
 <p className="text-[10px] text-muted font-bold uppercase tracking-widest mb-10">
 Studio Startup Pipeline
 </p>

 {/* Animated SVG Crochet Arena */}
 <div className="w-full h-48 relative flex items-center justify-center mb-8 bg-vibrant-cream rounded-3xl border-2 border-subtle overflow-hidden">
 ...
 <path d="M20 170 H380" stroke="var(--color-subtle)" strokeWidth="2" strokeDasharray="4 4" />
 <path d="M20 180 H380" stroke="var(--color-subtle)" strokeWidth="2" strokeDasharray="8 6" />
 ...
 fill="none" 
 opacity="0.25"
 className="yarn-spin-reverse"
 />
 {/* Cute heart tag on yarn */}
 <g transform="translate(-15, 25) rotate(-20)">
 <rect width="18" height="12" rx="3" fill="var(--color-subtle)" stroke="var(--color-heading)" strokeWidth="1" />
 <text x="5" y="9" fill="var(--color-brand)" fontSize="7" fontWeight="bold">yarn</text>
 </g>
 </g>
 ...
 <path d="M 244 133 C 242 135, 240 137, 239 140 C 238 143, 239 146, 243 144" stroke="var(--color-heading)" strokeWidth="1.5" strokeLinecap="round" fill="none" />
 {/* Grip pad wrapping */}
 <rect x="290" y="85" width="22" height="10" rx="3" fill="var(--color-subtle)" stroke="var(--color-heading)" strokeWidth="1" transform="rotate(-45, 290, 85)" />
 ...
 <p className="text-xs text-muted font-mono mt-1 font-medium tracking-tight">
 ...
 <div className="h-2 w-full bg-page rounded-full border border-subtle relative overflow-visible">
 ...
 <span className="text-[9px] font-bold font-mono text-brand mt-0.5">{Math.floor(progress)}%</span>
 </div>
 </div>
 </div>
