...
export function TerminologyToggle({ value, onChange }: TerminologyToggleProps) {
 ...
 <span className="text-[11px] md:text-xs font-bold text-muted uppercase tracking-widest pl-2 pr-1 font-sans hidden sm:inline">
 Terminology
 </span>
 ...
 type="button"
 onClick={() => onChange('US')}
 className={`px-3 py-1 text-[11px] md:text-xs font-bold rounded-full transition-all duration-200 cursor-pointer ${
 value === 'US'
