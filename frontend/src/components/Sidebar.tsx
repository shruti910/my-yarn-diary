...
export function Sidebar({
    ...
    return (
        <div
            ...
            className={`bg-surface flex flex-col h-full shrink-0 transition-all duration-300 ease-in-out z-40 ${isCollapsed
                ? 'hidden lg:flex w-0 border-r-0 overflow-hidden'
            ...
            <div className="w-[85vw] max-w-[320px] lg:w-80 h-full flex flex-col shrink-0">
                ...
                {isAdding && (
                    <form onSubmit={handleAddSubmit} className="px-6 py-2">
                        <div className="flex items-center gap-1 bg-white p-1 border border-subtle rounded-xl shadow-xs">
                            <input
                                type="text"
                                autoFocus
                                ...
                                className="bg-transparent border-none text-xs text-heading p-1.5 focus:outline-none w-full placeholder-muted font-semibold disabled:opacity-60"
                            />
                            <button
                                type="submit"
                                disabled={isSubmitting}
                            ...
                            <button
                                ...
                                className="p-1 text-muted hover:text-muted disabled:opacity-40"
                            >
                                    ...
                                    {isEditing ? (
                                        <>
                                            ...
                                            <button
                                                ...
                                                disabled={isSubmitting}
                                                className="p-1 rounded text-muted hover:bg-stone-100 disabled:opacity-40"
                                            >
                                                <X className="w-3 h-3" />
                                            </button>
                                        </>
                                        ...
                                        !isSystem && !isProtected && (
                                            <div className="flex opacity-0 group-hover:opacity-100 transition-opacity gap-0.5">
                                                <button
                                                    ...
                                                    className="p-1 rounded text-muted hover:text-brand hover:bg-white/70"
                                                    title="Rename"
                                                >
                    ...
                    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/45 backdrop-blur-xs select-none">
                        ...
                        >
                            ...
                            <div className="flex justify-between items-center pb-2 border-b border-subtle">
                                <h3 className="font-serif font-extrabold text-heading text-lg flex items-center gap-2">
                                    <CircleUserRound className="w-5 h-5 text-brand" />
                                    Profile Settings
                                </h3>
                                <button
                                    onClick={() => setIsProfileOpen(false)}
                                    className="p-1.5 rounded-lg hover:bg-stone-100 text-muted transition-colors cursor-pointer"
                                >
                                    <X className="w-4 h-4" />
                                </button>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex flex-col items-center gap-3">
                                    <span className="text-[11px] font-bold text-muted uppercase tracking-widest self-start">Profile Picture</span>
                                    <div className="relative group w-24 h-24 rounded-full overflow-hidden border border-subtle shadow-xs bg-brand-light flex items-center justify-center">
                                        {tempProfilePicture ? (
                                            <img
                                            ...
                                            <div className="text-heading font-serif font-extrabold text-2xl">
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-[11px] font-bold text-muted uppercase tracking-widest">Display Name</label>
                                    <input
                                        type="text"
                                        ...
                                        maxLength={100}
                                        className="w-full px-4 py-2.5 bg-white border border-subtle rounded-xl text-xs font-semibold text-heading focus:border-brand outline-none transition-colors"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="flex justify-end gap-2 pt-2 border-t border-subtle">
                                <button
                                    type="button"
                                    onClick={() => setIsProfileOpen(false)}
                                    className="px-4 py-2 bg-surface hover:bg-page text-muted border border-subtle rounded-xl text-xs font-bold transition-all cursor-pointer"
                                >
                                    Cancel
                                </button>
                                <button
                                    ...
                                    className="px-5 py-2.5 bg-accent hover:bg-accent/90 text-white font-bold rounded-xl text-xs transition-all shadow-xs cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed flex items-center gap-1.5"
                                >
                                    {isSavingProfile ? (
                                        <>
                    ...
                    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/45 backdrop-blur-xs select-none">
                        ...
                        >
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2 bg-page/30 p-4 border border-subtle/40 rounded-2xl">
                                    <h4 className="text-xs font-bold text-accent uppercase tracking-widest">Change Password</h4>
                                    ...
                                    <button
                                        ...
                                        className="mt-2 px-4 py-2 border border-accent/40 bg-accent/10 hover:bg-accent/20 text-accent font-bold rounded-xl text-xs transition-all cursor-pointer"
                                    >
                                        Change Password
                                    </button>
                                </div>
                                ...
                                <div className="space-y-2 bg-stone-50/50 p-4 border border-subtle/40 rounded-2xl">
                                    <h4 className="text-xs font-bold text-heading uppercase tracking-widest">Delete Account</h4>
                                    <p className="text-[11px] text-muted font-semibold leading-relaxed">
                                    ...
                                    <div className="flex items-center justify-between bg-white border border-subtle/60 px-3.5 py-2.5 rounded-xl mt-1">
                                        <a
                            ...
                            <div className="flex justify-end pt-2 border-t border-subtle">
                                <button
                                    type="button"
                                    onClick={() => setIsSettingsOpen(false)}
                                    className="px-5 py-2.5 bg-accent hover:bg-accent/90 text-white font-bold rounded-xl text-xs transition-all shadow-xs cursor-pointer"
                                >
                                    Close
                                </button>
                            </div>
                ...
                {isChangePasswordOpen && (
                    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/45 backdrop-blur-xs select-none">
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                <div className="space-y-1.5">
                                    <label className="text-[11px] font-bold text-muted uppercase tracking-widest">Current Password</label>
                                    <input
                                        type="password"
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-[11px] font-bold text-muted uppercase tracking-widest">New Password</label>
                                    <input
                                        type="password"
                                        value={newPassword}
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-[11px] font-bold text-muted uppercase tracking-widest">Confirm New Password</label>
                                    <input
                                        type="password"
